...
const ContactSection = () => {
  ...
  const onSubmit = async (event) => {
   ...
   return (
    <section
  id="contact"
  className="relative flex justify-center items-center rounded-2xl min-h-screen bg-gray-800 p-6"
>
    <Image
    src="/Images/helloleft.png"
    alt="hello"
    width={200}
    height={200}
  />
  {/* Contact Form */}
  <form
    className="bg-white/30 rounded-2xl shadow-lg p-8 w-full max-w-md space-y-6 border-4 border-gray-600 hover:border-pink-400"
    onSubmit={onSubmit}
  >
